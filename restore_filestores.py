...
def filestore_db_odoo(deployment_name, db_name):
    ...
    try:
        subprocess.check_output('sh download_filestore.sh {} {}'.format(db_name, deployment_name),shell=True).decode('utf-8')

    except Exception as e:
        print("Error generating db_name ")
        print(e)
...
def upload_filestore_to_s3(list_db, data):
    ...
    for db in list_db:
        ...
        print('Successfully restored filestore')
        print('-'*20)
